...
- [ ] Driver: register/onboard, submit KYC references, remain offline until approval, publish GPS, accept a match, progress arriving/arrived/in-progress/completed, see 88% earnings.
...
- [ ] Daily gross bookings, 88% driver earnings and 12% platform commission reconcile to provider/cash reports and wallet entries.
